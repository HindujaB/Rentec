...
public partial class AddPostShop : System.Web.UI.Page
{
       ...
       // ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "password_match", "alert('" + rno + rent + district + location + feature + pid + path + "')", true);
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            try
            {
                ...
                SqlCommand cmdshop = new SqlCommand("insert into[shop](shop_ID,type,area,rent_per_month,ac_nonac)values('" + pid + "', '" + feature + "', '" + location + "', '" + rent + "', '" + acr + "')", con);
