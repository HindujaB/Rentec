<%@ Page Title="" Language="C#" MasterPageFile="~/Rentec.master" AutoEventWireup="true" CodeFile="ViewShop.aspx.cs" Inherits="ViewShop" %>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                          <div class="" style="border-bottom:1px solid black">
                            <h2><asp:Label ID="name" runat="server" Text="Shop Information"></asp:Label></h2>
                      ...
                      <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="clearfix"></div><div class="bot-border"></div>
                                <div class="col-sm-6 col-xs-6 tital " >Air conditioned or not:</div><div class="col-sm-6 col-xs-6 contant_i"><asp:Label ID="ac" runat="server" Text=""></asp:Label></div>
                                <div class="clearfix"></div><div class="bot-border"></div>
                             </div>    
                           <div class="col-md-6">
                                ...
                                <div class="clearfix"></div><div class="bot-border"></div>
                                <div class="col-sm-6 col-xs-6 tital " >Type:</div><div class="col-sm-6 col-xs-6 contant_i"><asp:Label ID="types" runat="server" Text=""></asp:Label></div>
                                <div class="clearfix"></div><div class="bot-border"></div>
                             </div>  
						   <div class="col-md-6">
                                <div class="col-sm-6 col-xs-6 tital " >Area :</div><div class="col-sm-6 col-xs-6 contant_i"><asp:Label ID="areas" runat="server" Text=""></asp:Label></div>
                                <div class="clearfix"></div><div class="bot-border"></div>
                                <div class="col-sm-6 col-xs-6 tital " >Rent per Month:</div><div class="col-sm-6 col-xs-6 contant_i"><asp:Label ID="rpm" runat="server" Text=""></asp:Label></div>
                                <div class="clearfix"></div><div class="bot-border"></div>
                             </div>  							 
